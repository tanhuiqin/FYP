...
const struct mgos_conf_entry mgos_config_schema_[205] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 204},
  ...
  {.type = CONF_TYPE_INT, .key = "gpio_trigger_pin", .offset = offsetof(struct mgos_config, app.gpio_trigger_pin)},
  {.type = CONF_TYPE_INT, .key = "gpio_echo_pin", .offset = offsetof(struct mgos_config, app.gpio_echo_pin)},
...
const struct mgos_config mgos_config_defaults = {
  ...
  .app.sensor_read_interval_ms = 2000,
  .app.gpio_trigger_pin = 16,
  .app.gpio_echo_pin = 17,
  .app.pulse_in_timeout_usecs = 1000000,
  .app.mqtt_tank_level_topic = "iot/toiletPaper1",
};
