 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.17.0/apps/Ultrasonic/esp32/build_contexts/build_ctx_127283027/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.17.0/apps/Ultrasonic/esp32/build_contexts/build_ctx_127283027/build/gen/mos_conf_schema.yml
 */
...
struct mgos_config_app {
  int sensor_read_interval_ms;
  int gpio_trigger_pin;
  int gpio_echo_pin;
  int pulse_in_timeout_usecs;
  const char * mqtt_tank_level_topic;
};
...
static inline int mgos_sys_config_get_app_sensor_read_interval_ms(void) { return mgos_config_get_app_sensor_read_interval_ms(&mgos_sys_config); }
void mgos_config_set_app_sensor_read_interval_ms(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_sensor_read_interval_ms(int v) { mgos_config_set_app_sensor_read_interval_ms(&mgos_sys_config, v); }

/* app.gpio_trigger_pin */
#define MGOS_CONFIG_HAVE_APP_GPIO_TRIGGER_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_GPIO_TRIGGER_PIN
int mgos_config_get_app_gpio_trigger_pin(struct mgos_config *cfg);
static inline int mgos_sys_config_get_app_gpio_trigger_pin(void) { return mgos_config_get_app_gpio_trigger_pin(&mgos_sys_config); }
void mgos_config_set_app_gpio_trigger_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_gpio_trigger_pin(int v) { mgos_config_set_app_gpio_trigger_pin(&mgos_sys_config, v); }

/* app.gpio_echo_pin */
#define MGOS_CONFIG_HAVE_APP_GPIO_ECHO_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_GPIO_ECHO_PIN
int mgos_config_get_app_gpio_echo_pin(struct mgos_config *cfg);
static inline int mgos_sys_config_get_app_gpio_echo_pin(void) { return mgos_config_get_app_gpio_echo_pin(&mgos_sys_config); }
void mgos_config_set_app_gpio_echo_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_gpio_echo_pin(int v) { mgos_config_set_app_gpio_echo_pin(&mgos_sys_config, v); }
...
static inline int mgos_sys_config_get_app_pulse_in_timeout_usecs(void) { return mgos_config_get_app_pulse_in_timeout_usecs(&mgos_sys_config); }
void mgos_config_set_app_pulse_in_timeout_usecs(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_pulse_in_timeout_usecs(int v) { mgos_config_set_app_pulse_in_timeout_usecs(&mgos_sys_config, v); }
...
static inline const char * mgos_sys_config_get_app_mqtt_tank_level_topic(void) { return mgos_config_get_app_mqtt_tank_level_topic(&mgos_sys_config); }
void mgos_config_set_app_mqtt_tank_level_topic(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_app_mqtt_tank_level_topic(const char * v) { mgos_config_set_app_mqtt_tank_level_topic(&mgos_sys_config, v); }
