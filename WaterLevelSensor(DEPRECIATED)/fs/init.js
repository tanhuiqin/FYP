...
load('api_adc.js'); //imported for adc to work

ADC.enable(34); //Enable ADC pin 34
...
let topic = 'iot/ramdata' + Cfg.get('device.id');

Timer.set(2000 /* milliseconds */, Timer.REPEAT, function() {
  let msg = JSON.stringify({free: Sys.free_ram(), total: Sys.total_ram(), date:Timer.now(),Water:ADC.read(34)});
  print(topic, '->', msg);
